...
- `classic/` 下 38 张名画重构壁纸（31 张 1920x1080 + 7 张 1280x720，约 15MB）：

  - 以世界名画为蓝本，奶龙/奶破龙为主角重构（《自由引导奶龙》《奶龙之筏》《以利龙在迦密山》等）
  - 油画质感，适配 1080p 显示器直接设为桌面背景

```
wallpapers/
├── fullhd/nailong-01.jpg   ~  nailong-28.jpg   # 22 张壁纸（卡片海报风）
├── classic/     # 38 张名画重构壁纸（1920x1080/1280x720，油画质感）
